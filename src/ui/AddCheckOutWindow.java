...
public class AddCheckOutWindow {
	...
	{
		ObservableList<CheckOutEntry> obList = FXCollections.observableArrayList();
		DataAccess da = new DataAccessFacade();
		HashMap<String,CheckOutEntry> memberMap = DataAccessFacade.readCheckOutEntriesMap();
		memberMap.values().forEach(a -> obList.add(a));
		return obList;
	}
